...
#ifdef DEVS_DEVICHO
  SingleParallelModelAdm::Instance().registerAtomic( NewAtomicFunction<SistemaExcretor>() , "SistemaExcretor" ) ;
  SingleParallelModelAdm::Instance().registerAtomic( NewAtomicFunction<SistemaSalud>() , "SistemaSalud" ) ;
  SingleParallelModelAdm::Instance().registerAtomic( NewAtomicFunction<SistemaDigestivo>() , "SistemaDigestivo" ) ;
  SingleParallelModelAdm::Instance().registerAtomic( NewAtomicFunction<SistemaJuego>() , "SistemaJuego" ) ;
#endif //DEVS_DEVICHO
